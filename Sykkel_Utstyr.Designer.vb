...
Partial Class Sykkel_Utstyr
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label6.Location = New System.Drawing.Point(334, 36)
        ...
        Me.Label5.Text = "Antall sykler som leied:"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Antall sykler til utleie:"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Antall sykler i base:"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Antall kunder i base:"
        '
        'Label1
        '
